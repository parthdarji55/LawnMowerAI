...
The result:
After roughly 30 generations or so did we see a real solutions to the given obstacle.
When the obstacle was not well defined it took longer and was not an optimal solution.
